...
def test_TS_RDCC_202_TC_RDCC_204_PK_Check(db_connection: connection | None,validation: dict[str, str]):
    print("\nThis test case validates the coulmns in dim_regcor_container_closure_system  table is being transformed as no_source_values in case of null present in source table.\n")
